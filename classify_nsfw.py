...
def caffe_preprocess_and_compute(pimg,
...
def calc(image_data):
    ...
    nsfw_net = caffe.Net(
        "nsfw_model/deploy.prototxt",  # pylint: disable=invalid-name
    ...
    caffe_transformer.set_transpose('data', (
        2, 0, 1))  # move image channels to outermost
    ...
    caffe_transformer.set_channel_swap('data', (
...
if __name__ == '__main__':
    image_data = open('test_image.jpg').read()
    score = calc(image_data)
    print(score)
